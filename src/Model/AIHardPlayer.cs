...
namespace BattlieshipC
{
    ...
    /// </summary>
        ...
        {
            private readonly AIPlayer.Location _ShotAt;
            private readonly AIPlayer.Location _Source;
        ...
        /// <returns>The target shot at</returns>
            public AIPlayer.Location ShotAt
            {
                get
                {
                    return _ShotAt;
        ...
        /// <returns>The source that added this location as a target.</returns>
            public AIPlayer.Location Source
            {
                get
                {
                    return _Source;
            ...
            internal Target(AIPlayer.Location shootat, AIPlayer.Location source)
            {
                _ShotAt = shootat;
                _Source = source;
            }
